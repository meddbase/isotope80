...
namespace Isotope80
{
    ...
    public static class Assertions
    {
        ...
        /// <summary>
        /// Assert that fact is True (async)
        /// </summary>
        /// <param name="fact">Async fact to assert</param>
        /// <param name="label">Label on failure</param>
        public static IsotopeAsync<Unit> assert(IsotopeAsync<bool> fact, string label) =>
            from f in fact
            from _ in assert(f, label)
            select unit;
        ...
        public static IsotopeAsync<Unit> assertElementHasText(string cssSelector, string expected) =>
        ...
        /// <param name="expected">Label on failure</param>
        public static IsotopeAsync<Unit> assertElementHasText(Select selector, string expected) =>
        ...
        /// </summary>
        /// <param name="cssSelector">CSS selector</param>
        public static IsotopeAsync<Unit> assertElementIsDisplayed(string cssSelector) =>
        ...
        /// </summary>
        /// <param name="selector">Element selector</param>
        public static IsotopeAsync<Unit> assertElementIsDisplayed(Select selector) =>
